...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_embedding = DataEmbedding(configs.enc_in, 16, configs.embed, configs.freq,
                                           configs.dropout)
        self.model = nn.ModuleList([TimesBlock(configs)  # e_layers   Ĭ��Ϊ2, help='num of encoder layers'  �ж��Timesblock     ����Timesblock
                                    for _ in range(configs.d_layers)])
        # Encoder
        self.d_model=configs.d_model
        self.layer_norm = nn.LayerNorm(16)#�����еĲ���Ϊͨ����
        self.layer=configs.d_layers
        self.predict_linear = nn.Linear(
                self.seq_len, self.pred_len + self.seq_len)#��96,192��
        self.projection = nn.Linear(
                16, configs.c_out)#��512��Ϊ7   �ǣ�48,52,512������ά��Ϊ512,7��W��Ȩ�أ�
        self.projection1 = nn.Linear(
                 self.seq_len+self.label_len,self.pred_len + self.seq_len)#��512��Ϊ7   �ǣ�48,52,512������ά��Ϊ512,7��W��Ȩ�أ�
    ...
    def forecast1(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        for i in range(self.layer):
            enc_out = self.layer_norm(self.model[i](enc_out))#���ж��timesblock
